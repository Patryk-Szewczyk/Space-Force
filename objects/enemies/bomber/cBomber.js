...
class Bomber extends Enemy {
    ...
    constructor(engine, player, type, movementType, movementArgs, powerUp = false) {
        ...
        this.shooting = new BomberShooting(this.engineRef, this, this.shootingArgs);
    ...
    #setWorker() {
        this.worker = new Worker('/wp-content/themes/SpaceForceGame/objects/enemies/bomber/wBomber.js');
    ...
    #createObject() {
        ...
        object.setAttribute('class', 'bomber');
        for (let i = 0; i < 3; i++) {
    ...
    #selectType(type) {
        switch (type) {
            case 1:
              this.maxHp = 300;
              this.damage = 25;
              this.shootingArgs = {bulletsOnRound: 1, speed: 150, fireRate: 4.5, gapBetweenRounds: 1.5};
              this.image.classList.add('image-1');
              break;
            case 2:
              this.maxHp = 500;
              this.damage = 40;
              this.shootingArgs = {bulletsOnRound: 2, speed: 150, fireRate: 4.5, gapBetweenRounds: 1.5};
            ...
            case 4:
              this.maxHp = 1200;
              this.damage = 80;
              this.shootingArgs = {bulletsOnRound: 3, speed: 150, fireRate: 4.5, gapBetweenRounds: 1.5};
    ...
    #deleteEnemy(byPlayer) {
        if (byPlayer) {
            ...
            if (this.player.checkPlayerHpPowerUp()) {
                ...
                if (!this.powerUp) {
                Currency.createStarsGroup('bomber', this.type, this.objectTag);
                } else {
