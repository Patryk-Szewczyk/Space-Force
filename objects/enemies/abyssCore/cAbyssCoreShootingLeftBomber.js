...
class AbyssCoreShootingLeftBomber {
    ...
    constructor(engine, parent, shootingArgs) {
        ...
        this.parent = parent;
        this.shootingArgs = shootingArgs.leftBomber;
        this.speedX = shootingArgs.leftBomber.speed;
        this.speedY = shootingArgs.leftBomber.speed;
