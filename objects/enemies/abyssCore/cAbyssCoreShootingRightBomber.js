...
class AbyssCoreShootingRightBomber {
    ...
    constructor(engine, parent, shootingArgs) {
        ...
        this.parent = parent;
        this.shootingArgs = shootingArgs.rightBomber;
        this.speedX = shootingArgs.rightBomber.speed;
        this.speedY = shootingArgs.rightBomber.speed;
    ...
    startShooting() {
        ...
        this.LOOP_createBullets = setInterval(() => {  // Ciągłe strzelanie:
            ...
            const createSingleBullet = () => {
                ...
                bullet.setAttribute('class', 'bomber-bullet');
