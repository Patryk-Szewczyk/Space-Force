...
class AbyssCoreShootingRightFlamer {
    ...
    constructor(engine, parent, shootingArgs) {
        ...
        this.parent = parent;
        this.shootingArgs = shootingArgs.rightFlamer;
        this.speedX = shootingArgs.rightFlamer.speed;
        this.speedY = shootingArgs.rightFlamer.speed;
    ...
    startShooting() {
        ...
        this.LOOP_createBullets = setInterval(() => {  // Ciągłe strzelanie:
            ...
            const createSingleBullet = () => {
                ...
                bullet.setAttribute('class', 'flamer-bullet');
