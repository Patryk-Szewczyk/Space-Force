...
class AbyssCoreShootingRightShooter {
    ...
    constructor(engine, parent, shootingArgs) {
        ...
        this.parent = parent;
        this.shootingArgs = shootingArgs.rightShooter;
        this.speedX = shootingArgs.rightShooter.speed;
        this.speedY = shootingArgs.rightShooter.speed;
