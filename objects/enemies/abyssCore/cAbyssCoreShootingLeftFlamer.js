...
class AbyssCoreShootingLeftFlamer {
    ...
    constructor(engine, parent, shootingArgs) {
        ...
        this.parent = parent;
        this.shootingArgs = shootingArgs.leftFlamer;
        this.speedX = shootingArgs.leftFlamer.speed;
        this.speedY = shootingArgs.leftFlamer.speed;
