...
class MultiShooting {
    ...
    #determineBulletsSpeed() {
        ...
        const diagonalNorm = this.speedX / Math.sqrt(2);  // TODO: poprawka: // Stała długość wektora dla 45°
        switch (this.parent.movementType) {  // Na kierunku left pocisk dolny poruszał się zbyt szybko i to powód zmiany, TODO: zoptymalizuj resztę kodu wedug tego wzoru
            case 'horizontal':
                switch (this.parent.movementArgs.direction) {
                    // case 'left':
                    //     leftX = (this.speedX * -1) * biasDivide;
                    //     leftY = (this.speedY * -1) * biasDivide;
                    //     centerX = this.speedX * -1;
                    //     rightX = (this.speedX * -1) * biasDivide;
                    //     rightY = this.speedY / biasDivide;
                    //     this.speedX = {left: leftX, center: centerX, right: rightX};
                    //     this.speedY = {left: leftY, center: 0, right: rightY};
                    //     break;
                    // case 'right':
                    //     leftX = this.speedX * biasDivide;
                    //     leftY = (this.speedY * -1) * biasDivide;
                    //     centerX = this.speedX;
                    ...
                    //     this.speedY = {left: leftY, center: 0, right: rightY};
                    //     break;
                     case 'left':  // TODO: POPRAWKA NA SZYBKO, Zobacz później Orba!
                        leftX = -diagonalNorm;
                        leftY = -diagonalNorm;
                        centerX = -this.speedX;
                        rightX = -diagonalNorm;
            ...
            case 'bias':
                switch (this.parent.movementArgs.direction) {
                    case 'bottomLeft':
                        ...
                        centerY = this.speedY;
                        rightY = this.speedY;
                        this.speedX = {left: leftX, center: centerX, right: 0};
                        this.speedY = {left: 0, center: centerY, right: rightY};
                        break;
                    case 'bottomRight':
                        leftX = this.speedX;
                        centerX = this.speedX;
                    ...
                    case 'topLeft':
                        leftX = this.speedX * -1;
                        centerX = this.speedX * -1;
                        centerY = this.speedY * -1;
                        rightY = this.speedY * -1;
                        this.speedX = {left: leftX, center: centerX, right: 0};
                        this.speedY = {left: 0, center: centerY, right: rightY};
                        break;
                    case 'topRight':
            ...
            default:
                ...
                rightX = this.speedX * biasDivide;
                rightY = this.speedY * biasDivide;
                this.speedX = {left: leftX, center: 0, right: rightX};
